...
/**
 * CommunityCard — full community entry with header, impact badge,
 * image gallery strip, and contributions list.
    ...
    >
      <div className="mb-4">
        <div className="flex items-start justify-between mb-2">
          ...
          <span className={`px-3 py-1 rounded-full text-xs font-semibold bg-gradient-to-r ${gradient} text-white whitespace-nowrap ml-2`}>
      ...
      <div>
        ...
        <ul className="space-y-2">
          {contributions.map((contribution, conIndex) => (
            <li
              key={conIndex}
